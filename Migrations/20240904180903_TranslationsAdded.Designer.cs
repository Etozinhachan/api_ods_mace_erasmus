...
namespace api_ods_mace_erasmus.Migrations
{
    ...
    [Migration("20240904180903_TranslationsAdded")]
    partial class TranslationsAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api_ods_mace_erasmus.models.Translation", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("translation_json")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.Property<byte>("translation_state")
                        .HasColumnType("tinyint unsigned");
            ...
            modelBuilder.Entity("api_ods_mace_erasmus.models.Translation", b =>
                {
                    b.HasOne("api_ods_mace_erasmus.models.User", "submited_by_user")
                        .WithMany("submitted_translations")
                        .HasForeignKey("user_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("api_ods_mace_erasmus.models.User", b =>
                {
                    ...
                    b.Navigation("submitted_translations");
                });
